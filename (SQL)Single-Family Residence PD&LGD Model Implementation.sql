...
#           where Year = 'Y2018' and Time = 'Nov');
    ...
    # homework：
# 1.calculate adjusted value , LTV based on HPI
# 2. create temp table (column order, data type) finished already above
# 为了后续表格维护更高效，通过left join 表格t_woe-delq 到主表，如果woe有变化只需要update表格t_woe_delq就行
# 1.how to design WOE mapping table
# 2. how to leverage designed WOE mapping table to implement under the code
